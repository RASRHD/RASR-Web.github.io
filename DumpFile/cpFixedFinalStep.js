...
for (let i = 1; i <= 64; i++) {
    ...
    for (let j = 9; j <= 16; j++) {
        ...
        let idSebelumnya = localStorage.getItem("idSebelumnya")
        kotak.addEventListener("click", () => {
            if (blockDepanKeSatuHitam[j].style.backgroundColor == "red" && blockDepanKeDuaHitam[j].style.backgroundColor == "red") {
            ...
            } else if (blockDepanKeSatuHitam[j].style.backgroundColor == "red") {
                blockDepanKeSatuHitam[j].style.backgroundColor = blockDepanKeSatuHitam[j].style.color
                blockDepanKeDuaHitam[j].style.backgroundColor = blockDepanKeDuaHitam[j].style.color
                blockDepanKeSatuHitam[j].style.backgroundColor = "red"
            } else if (blockDepanKeDuaHitam[j].style.backgroundColor == "red") {
                blockDepanKeSatuHitam[j].style.backgroundColor = blockDepanKeSatuHitam[j].style.color
                blockDepanKeDuaHitam[j].style.backgroundColor = blockDepanKeDuaHitam[j].style.color
                blockDepanKeDuaHitam[j].style.backgroundColor = "red"
            } else if (idSebelumnya == "li" + (j + 40)) {
                console.log("asw");
            }
        })
        ...
        kotak.addEventListener("click", () => {
            ...
            } else if (blockDepanKeSatuPutih[j].style.backgroundColor == "red") {
                blockDepanKeSatuPutih[j].style.backgroundColor = blockDepanKeSatuPutih[j].style.color
                blockDepanKeDuaPutih[j].style.backgroundColor = blockDepanKeDuaPutih[j].style.color
                blockDepanKeSatuPutih[j].style.backgroundColor = "red"
            } else if (blockDepanKeDuaPutih[j].style.backgroundColor == "red") {
                blockDepanKeSatuPutih[j].style.backgroundColor = blockDepanKeSatuPutih[j].style.color
                blockDepanKeDuaPutih[j].style.backgroundColor = blockDepanKeDuaPutih[j].style.color
                blockDepanKeDuaPutih[j].style.backgroundColor = "red"
            } else if (idSebelumnya == "li" + (j + 40)) {
                console.log("asw");
            }
        })
